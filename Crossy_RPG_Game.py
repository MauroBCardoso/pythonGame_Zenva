...
class Game:
    ...
    def run_game_loop(self, level_speed):
        ...
        enemy_0 = NonPlayerCharacter('enemy.png', 20, 550, 45, 45)
        # Speed increased as we advance in difficulty
        enemy_0.SPEED *= level_speed

        # Create another enemy
        enemy_1 = NonPlayerCharacter('enemy.png', self.width - 40, 350, 45, 45)
        enemy_1.SPEED *= level_speed

        # Create another enemy
        enemy_2 = NonPlayerCharacter('enemy.png', 20, 200, 45, 45)
